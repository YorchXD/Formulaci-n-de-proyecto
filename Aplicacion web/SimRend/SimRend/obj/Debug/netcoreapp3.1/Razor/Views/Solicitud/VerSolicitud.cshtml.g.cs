#pragma checksum "D:\Repositorios\Formulación de proyecto\Aplicacion web\SimRend\SimRend\Views\Solicitud\VerSolicitud.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b75aaf79fafc4e1bad823aeeb3e1ba6de57c9fd4"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"b75aaf79fafc4e1bad823aeeb3e1ba6de57c9fd4", @"/Views/Solicitud/VerSolicitud.cshtml")]
      ...
      ");
        ...
        function obtenerSolicitud()
        {
            ...
            $.ajax({
                ...
                success: function (respuesta) {
                    ...
                    if ");
                WriteLiteral(@"(respuesta.solicitud.tipoEvento === ""Grupal"") {
        ...
        function verOpciones(opcion) {
            ...
            if (opcion < 3) {
                acciones = '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volverProceso"" style=""width:100%""><i class=""fas fa-sitemap""></i> Volver a proceso</button> </div>' +
                    ...
                    '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-warning""");
                WriteLiteral(@" id = ""modificar"" style=""width:100%""><i class=""fas fa-pen-square""></i> Modificar</button> </div>' +
                ...
                acciones = '<div class=""form-group  col-lg-4 col-md-4 col-sm-12""><button class=""btn btn-secondary"" id=""volverProceso"" style=""width:100%""><i class=""fas fa-arrow-alt-circle-left""></i> Volver a proceso</button> </div>' +
                    ...
                    '<d");
                WriteLiteral(@"iv class=""form-group  col-lg-4 col-md-4 col-sm-12""><button class=""btn btn-info"" id = ""descargar"" style=""width:100%""><i class=""fas fa-download""></i> Descargar</button> </div>';
            }
        ...
        function categorias(categorias) {
            ...
            for (var i = 0; i < categorias.length; i++) {
                if (i === 0 || i % 2 === 0) {
        ");
                WriteLiteral(@"            resp += ""<tr class='odd'>"";
                }
                else {
                    resp += ""<tr>"";
                }
