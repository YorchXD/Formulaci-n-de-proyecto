#pragma checksum "D:\Repositorios\Formulación de proyecto\Aplicacion web\SimRend\SimRend\Views\DeclaracionGastos\DocumentacionPersonas.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "eea7e5d27b348c3d8557fc18b0a6504154f3b564"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"eea7e5d27b348c3d8557fc18b0a6504154f3b564", @"/Views/DeclaracionGastos/DocumentacionPersonas.cshtml")]
...
");
            DefineSection("scripts", async() => {
                WriteLiteral("\r\n    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "eea7e5d27b348c3d8557fc18b0a6504154f3b56410371", async() => {
                }
                );
    ...
    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "eea7e5d27b348c3d8557fc18b0a6504154f3b56411828", async() => {
                }
                );
                __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
                __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
    ...
    <div>
        <script>
                ...
                WriteLiteral(@"
                        ...
                        },
                        {
                            ...
                            ""render"": function (data, type, row, meta)
                            {
                                ...
                                return '<button class=""btn btn-success btn-icon rounded-circle mg-r-5 mg-b-10"" onclick=""ver(\'' + data.toString()");
                ...
                for (var i = 0; i < cantParticipantes; i++)
                {
                    if (datos.participantes[i].documentos != null)
                    {
                        ...
                        for (var j = 0; j < cantDocumentos; j++)
                        {
                            ...
                            {
                                montoDocsSelec += dato");
                WriteLiteral(@"s.participantes[i].documentos[j].monto
                            }
                        }
                    }
            ...
            function insertarAcciones(estado, estadoFinal)
            {
                ...
                {
                    var volver = '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""> <button class=""btn btn-secondary""  style=""width:100%"" onclick=""volver()""><i cla");
                WriteLiteral(@"ss=""fas fa-arrow-circle-left""></i> Volver</button></div>';
            ...
            {
                numeroRegexp = new RegExp('\\d\\.(\\d){' + decimales + ',}');   // Ex");
                WriteLiteral(@"presion regular para numeros con un cierto numero de decimales o mas
            ...
            function ver(idParticipante)
            {
                $.ajax({
                    ...
                    {
                        wi");
                WriteLiteral(@"ndow.location.href = '/DeclaracionGastos/Documentos';
                    },
                    error: function (XMLHttpRequest, textStatus, errorThrown)
                    {
                        $('#title-alerta').text(textStatus);
            ...
            function eliminar(idParticipante)
            {
                ...
                $('#body-alerta-eliminar-documento').text(""¿Está seguro que desea eliminar todos los");
                ...
                WriteLiteral(@"ethod: ""POST"",
                    ...
                    success: function (respuesta)
                    {
                        ...
                        else if (respuesta == ""0"")
                        {
                            ...
                            var boton = '<button type=""button"" data-dismiss=""modal"" class=""btn btn-danger tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-m");
                WriteLiteral(@"edium mg-b-20"">Aceptar</button>';
            ...
            function eliminarDocumentosDG()
            {
                ...
                $('#actions-alerta-eliminar-documento').empty().append(botonCancelar);
        ");
                WriteLiteral(@"        $('#actions-alerta-eliminar-documento').append(botonAceptar);
                $('#modal-alerta-eliminar-documento').modal('show');
            }
            ...
            function confirmarEliminarDocumentosDG()
            {
                ...
                WriteLiteral(@"      else if (respuesta == ""0"")
                        ...
                        else
                        {
                            $('#title-alerta').text(""Alerta"");
                            $('#body-alerta').text(""No se eliminaron los documentos debido a que ha ocurrido un problema de conexión. Favor de volver a intentarlo y si el problema persiste contactar a soporte"");
                            var boton = '<button type=""button"" data-dismi");
                WriteLiteral(@"ss=""modal"" class=""btn btn-danger tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium mg-b-20"">Aceptar</button>';
                            $('#actions-alerta').empty().append(boton);
                            $('#modal-alerta').modal('show');
                        }
                    },
