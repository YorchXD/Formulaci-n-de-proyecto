#pragma checksum "D:\Repositorios\Formulación de proyecto\Aplicacion web\SimRend\SimRend\Views\DeclaracionGastos\DocumentacionPersonas.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6cb870dd136a87ec7ce19c856cf6c3563f37ab35"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6cb870dd136a87ec7ce19c856cf6c3563f37ab35", @"/Views/DeclaracionGastos/DocumentacionPersonas.cshtml")]
 ...
 ");
    ...
    <div id=""modal-informacion-eliminacion"" class=""modal fade"" data-backdrop=""static"" data-keyboard=""false"">
        <div class=""modal-dialog modal-dialog-centered"" role=""document"">
            <div class=""modal-content tx-size-sm"">
                <di");
            WriteLiteral(@"v class=""modal-body tx-center pd-y-20 pd-x-20"">
...
");
            DefineSection("scripts", async() => {
                WriteLiteral("\r\n    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6cb870dd136a87ec7ce19c856cf6c3563f37ab3510373", async() => {
                }
                );
    ...
    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6cb870dd136a87ec7ce19c856cf6c3563f37ab3511830", async() => {
                }
                );
                __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
                __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
    ...
    <div>
        <script>
         ...
         ");
                WriteLiteral(@"                       return formatoNumero(monto);
                            }
                        },
                        {
                            ""data"": 'documentos',
                        ...
                        },
                        {
                            ...
                            {
           ");
                WriteLiteral(@"                     return '<button class=""btn btn-success btn-icon rounded-circle mg-r-5 mg-b-10"" onclick=""ver(\'' + data.toString() + '\')""><div><i class=""fas fa-eye""></i></div></button>' +
       ...
       ");
                WriteLiteral(@"         for (var i = 0; i < cantParticipantes; i++)
                {
                ...
                va");
                WriteLiteral(@"r porcentajeDocsSelec = (montoDocsSelec / datos.montoSolicitado) * 100;
     ...
     ");
            ...
            function redondearDecimales(numero, decimales)
            {
                ...
                {
                    return Number(numero.toFixed(decimales)) === 0 ? 0 : numero;  // En v");
                WriteLiteral(@"alores muy bajos, se comprueba si el numero es 0 (con el redondeo deseado), si no lo es se devuelve el numero otra vez.
                }
            }
            ...
            ");
                WriteLiteral(@"function eliminar(idParticipante)
            {
                IdParticipante = idParticipante;
            ...
            function confirmarEliminarDocumentosDG()
            {
                ...
                WriteLiteral(@"= ""0"")
                        ...
                        else
                        {
                            $('#title-alerta').text(""Alerta"");
                            $('#body-alerta').text(""No se eliminaron los documentos debido a que ha ocurrido un problema de conexión. Favor de volver a intentarlo y si el problema persiste contactar a soporte"");
                            var boton = '<button type=""button"" data-dismiss=""modal"" class=""btn btn-");
                WriteLiteral(@"danger tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium mg-b-20"">Aceptar</button>';
                            $('#actions-alerta').empty().append(boton);
                            $('#modal-alerta').modal('show');
                        }
                    }
