#pragma checksum "D:\Repositorios\Formulación de proyecto\Aplicacion web\SimRend\SimRend\Views\Proceso\VerProceso.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e1e459ccc95f5200595797e8c82070240b62edf9"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e1e459ccc95f5200595797e8c82070240b62edf9", @"/Views/Proceso/VerProceso.cshtml")]
            ...
            <div class=""row mg-b-25"">
                <div class=""form-group wd-auto col-lg-12 col-md-12"">
                    ...
                    <div class=""input-group"">
                        ...
                        <input name=""NombreEvento"" class=""form-control"" id=""verNombreEvento"" reado");
            WriteLiteral(@"nly type=""text"" placeholder=""Ingrese el nombre del evento"">
                    </div>
                </div>
            ...
            WriteLiteral(@"  <div class=""input-group-prepend"">
                ...
                <div class=""form-group wd-auto col-lg-6 col-md-12"">
                    ...
                    <div class=""input-group"">
                        ...
                        <input name=""Fech");
            WriteLiteral(@"aInicio"" type=""text"" class=""form-control fc-datepicker"" readonly placeholder=""¿Cuando inicia el evento?"" id=""verFechaInicio"">
                    </div>
                </div>
                <div class=""form-group wd-auto col-lg-6 col-md-12"">
                ...
                <div class=""form-group wd-auto col-lg-6 col-md-12"">
                    <label class=""form-control-label"">Responsabl");
        ...
        function verOpciones(estado, estadoFinal) {
            ...
            switch (estado) {
                case 1:
                    ...
                    {
                        acciones = '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volver"" style=""width:100%""><");
                WriteLiteral(@"i class=""fas fa-arrow-alt-circle-left""></i> Volver</button> </div>' +
                ...
                case 2:
                    if (estadoFinal == 'Abierto')
                    {
                        acciones = '<div class=""form-group  col-lg-4 col-md-4 col-sm-12""><button class=""btn btn-secondary"" id=""volver"" style=""width:100%""><i class=""fas fa-arrow-alt-circle-left""></i> Volver</button> </div>' +
                            ...
                            '<div class=""form-group  col-lg-4 col-md-4 col-sm-12""><button class=""btn btn-info "" id = ""agregarResolucion"" style=");
                WriteLiteral(@"""width:100%""><i class=""fas fa-plus-circle""></i> Resolución</button> </div>';
                    }
                    else
                    {
                        acciones = '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volver"" style=""width:100%""><i class=""fas fa-arrow-alt-circle-left""></i> Volver</button> </div>' +
                ...
                case 3:
                    ...
                    {
                        acciones = '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volver"" style=""width:100%""><i class=""fas fa-arrow-alt-circle-left""></i> Volver</button> </div>' +
                            '<div class=""form-group  col-lg-6 col-m");
                WriteLiteral(@"d-6 col-sm-12""><button class=""btn btn-secondary"" id=""verSolicitud"" style=""width:100%""><i class=""fas fa-eye""></i> Solicitud</button> </div>' +
                    ...
                    {
                        acciones = '<div class=""form-group  col-lg-4 col-md-4 col-sm-12""><button class=""btn btn-secondary"" id=""volver"" style=""width:100%""><i class=""fas fa-arrow-alt-circle-left""></i> Volver</button> </div>' +
                            '<div class=""form-group  col-lg-4 col-md-4 col-sm-12""><button class=""btn btn-info"" id=""verSolicitud"" style=""width:100%""><");
                WriteLiteral(@"i class=""fas fa-eye""></i> Solicitud</button> </div>' +
                            '<div class=""form-group  col-lg-4 col-md-4 col-sm-12""><button class=""btn btn-info"" id=""verResolucion"" style=""width:100%""><i class=""fas fa-eye""></i> Resolución</button> </div>';
                    }
                    break;
                default:
                    acciones = '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volver"" style=""width:100%""><i class=""fas fa-arrow-alt-circle-left""></i> Volver</button> </div>' +
                        ...
                        '<div class=""form-group col-lg-6 co");
                WriteLiteral(@"l-md-6 col-sm-12""><button class=""btn btn-info"" id=""verDeclaracionGasto"" style=""width:100%""><i class=""fas fa-eye""></i> Declaración de gastos</button> </div>';
                    break;
                /*case 5:
                    acciones = '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volver"" style=""width:100%""><i class=""fas fa-arrow-alt-circle-left""></i> Volver</button> </div>' +
                        '<div class=""form-group col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-info"" id=""verSolicitud"" style=""width:100%""><i class=""fas fa-eye""></i> Solicitud</button> </div>' +
                        '<div class=""form-group col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-info"" id=""verResolucion"" style=""width:100%""><i class=""fas fa-eye""></i> Resolución</button> </div>' +
                        '<div class=""form-group col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-info"" id=""verDeclaracionGasto"" style=""width:100%""><i class=""fas fa-eye""></i> Declaraci");
                WriteLiteral(@"ón de gastos</button> </div>';
                    break;*/
            }
            ...
            $('#verResolucion').click(function (e) {
                e.preventDefault();
     ");
                WriteLiteral(@"           //alert(""Ver resolución
        ...
        function datosPrincipales(solicitud)
        {
            ...
            $(""#verFechaInicio"").val(solicitud.fe");
                WriteLiteral(@"chaInicioEvento.split(""T"")[0]);
