#pragma checksum "D:\Repositorios\Formulación de proyecto\Aplicacion web\SimRend\SimRend\Views\Resolucion\VerResolucion.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7eb75e17b04491a54b4bf94b65c0ce750b823480"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7eb75e17b04491a54b4bf94b65c0ce750b823480", @"/Views/Resolucion/VerResolucion.cshtml")]
                ...
                <div class=""modal-dialog modal-dialog-centered"" role=""document"">
                    <div class=""modal-content tx-size-sm"">
                        <div class=""modal-body tx-center pd-y-20 pd-x-20"">
                            ...
                            <button type=""button"" id=""btnConfirmarEliminar"" class=""btn btn-danger tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mo");
            WriteLiteral(@"nt tx-medium mg-b-20"">
                                Aceptar
                            </button>
                        </div><!-- modal-body -->
                    </div>
                ...
                <div class=""modal-dialog modal-dialog-centered"" role=""document"">
                    <div class=""modal-content tx-size-sm"">
                        <div class=""modal-body tx-center pd-y-20 pd-x-20"">
                            ...
                            <p class=""mg-b-20 mg-x-");
            WriteLiteral(@"20"" id=""body-alerta""></p>
...
");
            DefineSection("scripts", async() => {
                WriteLiteral("\r\n    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "7eb75e17b04491a54b4bf94b65c0ce750b82348010942", async() => {
                }
                );
    ...
    <script>
        ...
        function obtenerResolucion()
        {
            $.ajax({
                ...
                success: function (respuesta)
                {
                    ...
                    v");
                WriteLiteral(@"erOpciones(respuesta.estado);
                },
        ...
        function verOpciones(opcion)
        {
            ...
            switch (opcion)
            {
                ...
                WriteLiteral(@"6 col-md-6 col-sm-12""><button class=""modal-effect btn btn-warning"" data-effect=""effect-just-me"" id = ""modificar"" style=""width:100%""><i class=""fas fa-pen-square""></i> Modificar</button> </div>' +
            ...
            $('#volve");
                WriteLiteral(@"rProceso').click(function (e)
            {
                e.preventDefault();
        ...
        {
            e.preventDefault();
            $('#modal-confirmar-eliminar').modal(");
                WriteLiteral(@"'hide');
            $.ajax({
