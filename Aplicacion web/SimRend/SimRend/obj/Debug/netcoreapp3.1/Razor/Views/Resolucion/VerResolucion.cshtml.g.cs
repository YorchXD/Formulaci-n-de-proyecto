#pragma checksum "D:\Repositorios\Formulación de proyecto\Aplicacion web\SimRend\SimRend\Views\Resolucion\VerResolucion.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "3f8e8296a85e0638a43844b79e1308c73ccdf594"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"3f8e8296a85e0638a43844b79e1308c73ccdf594", @"/Views/Resolucion/VerResolucion.cshtml")]
...
");
            DefineSection("scripts", async() => {
                WriteLiteral("\r\n    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "3f8e8296a85e0638a43844b79e1308c73ccdf59410942", async() => {
                }
                );
    ...
    <script>
        ...
        function verOpciones(opcion)
        {
            ...
            switch (opcion)
            {
                case 3:
                    acciones = '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volverProceso"" style=""width:100%""><i class=""fas fa-sitemap""></i> Volver a proceso</button> </div>' +
                        ...
                        '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button clas");
                WriteLiteral(@"s=""btn btn-danger"" id = ""eliminar"" style=""width:100%""><i class=""fas fa-trash""></i> Eliminar</button> </div>';
                    break;
                default:
                    acciones = '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volverProceso"" style=""width:100%""><i class=""fas fa-sitemap""></i> Volver a proceso</button> </div>' +
                        '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volverProcesos"" style=""width:100%""><i class=""fas fa-clipboard-list""></i> Volver a procesos</button> </div>';
            ...
            $('#volverProcesos').click(function (e)
            {
                e.preventDefault();
                ");
                WriteLiteral(@"window.location.href = '/Proceso/Procesos/';
            });
