#pragma checksum "D:\Repositorios\Formulación de proyecto\Aplicacion web\SimRend\SimRend\Views\DeclaracionGastos\VerDeclaracionGastos.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4d5f18c28eb846be5466431d67b0eb014bcf18d8"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4d5f18c28eb846be5466431d67b0eb014bcf18d8", @"/Views/DeclaracionGastos/VerDeclaracionGastos.cshtml")]
    ...
    <script>
        ...
        function verOpciones(opcion)
        {
            ...
            switch (opcion)
            {
                case 3:
                    acciones = '<di");
                WriteLiteral(@"v class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volverProceso"" style=""width:100%""><i class=""fas fa-sitemap""></i> Volver a proceso</button> </div>' +
                ...
                case 4:
                    acciones = '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volverProceso"" style=""width:100%""><i class=""fas fa-sitemap""></i> Volver a proceso</button> </div>' +
                        '<div class=""form-g");
                WriteLiteral(@"roup  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volverProcesos"" style=""width:100%""><i class=""fas fa-clipboard-list""></i> Volver a procesos</button> </div>' +
                        ...
                        '<div class=""form-group col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-info"" id=""descargar"" style=""width:100%""><i class=""fas fa-downl");
                WriteLiteral(@"oad""></i> Descargar</button> </div>' +                        
                ...
                default:
                    acciones = '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volverProceso"" style=""width:100%""><i class=""fas fa-sitemap""></i> Volver a proceso</button> </div>' +
                        ...
                        '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""modal-effect btn btn-info"" data-effect=""effect-just-me"" id = ""documentacion"" style=""width:100%""><i class=""fas fa-eye""></i> Documentación</button> </div>' +
    ");
                WriteLiteral(@"                    '<div class=""form-group col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-info"" id=""descargar"" style=""width:100%""><i class=""fas fa-download""></i> Descargar</button> </div>';
                    break;
            }
            ...
            $('#documentacion').click(function (e)
            {
                ...
                {
                    case 'Grupal':
                        window.location.href = '/DeclaracionGastos/DocumentacionPer");
                WriteLiteral(@"sonas';
                        break;
                    default:
            ...
            $('#eliminar').click(function (e)
            {
                e.preventDefault();
                alert('Eliminar ");
                WriteLiteral("documentación de la declaración de gastos\');\r\n            });\r\n        }\r\n    </script>\r\n");
            }
            );
        }
