#pragma checksum "D:\Repositorios\Formulación de proyecto\Aplicacion web\SimRend\SimRend\Views\DeclaracionGastos\VerDeclaracionGastos.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "664121ab520553b63f483fab632f13318a72c573"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"664121ab520553b63f483fab632f13318a72c573", @"/Views/DeclaracionGastos/VerDeclaracionGastos.cshtml")]
...
");
                WriteLiteral(@"                    $('#totalRendido').val(formatoNumero(respuesta.proceso.declaracionGastos.totalRendido));
                ...
                error: function (XMLHttpRequest, textStatus, errorThrown)
                {
                    ...
                    var boton = '<button type=""button"" data-dismiss=""modal"" class");
                WriteLiteral(@"=""btn btn-danger tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium mg-b-20"">Aceptar</button>';
                ...
                switch (estado)
                {
                    case 3:
                        acciones = '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volverProceso"" style=""width:100%""><i class=""fas fa-sitemap""></i> Volver a proceso</button> </div>' +
                            '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volverProcesos"" style=""width:100%");
                WriteLiteral(@"""><i class=""fas fa-clipboard-list""></i> Volver a procesos</button> </div>' +
                    ...
                    case 4:
                        acciones = '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volverProceso"" style=""width:100%""><i class=""fas fa-sitemap""></i> Volver a proceso</button> </div>' +
                            ...
                            '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""modal-effect btn btn-info"" data-effect=""effect-just-me"" s");
                WriteLiteral(@"tyle=""width:100%"" onclick=""documentacion()""><i class=""fas fa-eye""></i> Documentación</button> </div>' +
                        ...
                        break;
                    default:
                        acciones = '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volverProceso"" style=""width:100%""><i class=""fas fa-s");
                WriteLiteral(@"itemap""></i> Volver a proceso</button> </div>' +
                            '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volverProcesos"" style=""width:100%""><i class=""fas fa-clipboard-list""></i> Volver a procesos</button> </div>' +
...
");
                WriteLiteral(@"                            '<div class=""form-group col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-info"" id=""aceptar"" style=""width:100%""><i class=""fas fa-check-square""></i> Declaración aceptada</button> </div>';
                        break;
                }
            }
            else
            {
                switch (estado)
                {
                    case 3:
                        ...
                        break;
                    case 4:
                        acciones = '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""");
                WriteLiteral(@"btn btn-secondary"" id=""volverProceso"" style=""width:100%""><i class=""fas fa-sitemap""></i> Volver a proceso</button> </div>' +
                            '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volverProcesos"" style=""width:100%""><i class=""fas fa-clipboard-list""></i> Volver a procesos</button> </div>' +
                    ...
                    default:
                        acciones = '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volverProceso"" style=""width:100%""><i class=""fas fa-sitemap""></i> Volver a proceso</button> </div>' +
                            '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary""");
                WriteLiteral(@" id=""volverProcesos"" style=""width:100%""><i class=""fas fa-clipboard-list""></i> Volver a procesos</button> </div>' +
            ...
            $('#volverProcesos').click(function (e)
            {
                e.preventDefault();
                window.location.");
                WriteLiteral(@"href = '/Proceso/Procesos/';
            });
            ...
            $('#generar').click(function (e)
            {
                ...
                var botonAceptar = '<button type=""button"" class=""btn btn-success tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium mg-b-20 mg-l-5"" onclick=""seleccionarDocumentacionAutomatica()"">Aceptar</button>';
            ...
            $('#finalizar').click(function (e)
            {
                ...
                $('#body-alerta-informacion').text(""¿Está seguro que desea finalizar la delcaración de gastos?"");

                var botonCancelar = '<button type=""button"" data-dismiss=""modal"" class=""btn btn-secondary tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium mg-b-20 mg-r-5"">Cancelar</button >';
                var botonAceptar = '<button type=""button"" class=""btn btn-success tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium mg-b-20 mg-l-5"" onclick=""FinalizarDG()"">Aceptar</butto");
                WriteLiteral(@"n>';
            ...
            {
                e.preventDefault();
                $('#icono-alerta').empty().append('<i class=""icon icon ion-ios-help-outline tx-100 tx-danger lh-1 mg-t-20 d-inline-block""></i>');
                ...
                var botonCancelar = '<button type=""button"" data-dismiss=""modal"" class=""btn btn-secondary tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-mediu");
                WriteLiteral(@"m mg-b-20 mg-r-5"">Cancelar</button >';
            ...
            $('#aceptar').click(function (e)
            {
                ...
                var botonCancelar = '<button type=""button"" data-dismiss=""modal"" class=""btn btn-secondary tx-11 tx-uppercase pd-y-1");
                WriteLiteral(@"2 pd-x-25 tx-mont tx-medium mg-b-20 mg-r-5"">Cancelar</button >';
        ...
        function seleccionarDocumentacionAutomatica()
        {
            ...
            $.ajax({
                ...
                success: function (respuesta)
                {
                    if (respuesta == true)
                    {
                        $('#icono-alerta-informacion').empty().append('<i class=""icon icon ");
                WriteLiteral(@"ion-ios-checkmark-outline tx-100 tx-success lh-1 mg-t-20 d-inline-block""></i>');
                ...
                WriteLiteral(@""");
                        $('#body-alerta').text(""No se han seleccionado documentos automaticamente para generar la declaración de gastos. Favor de volver a intentarlo y si el problema persiste, contactese con soporte."");
                ...
                error: function (XMLHttpRequest, textStatus, errorThrown)
                {
                    ...
                    $('#body-alerta').text(errorThrown);
                    var boton = '<button type=""button"" data-dismiss=""modal"" class=""btn btn-danger tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium mg-b-20"">Aceptar</button>';
                    $('#actions-alerta').empty().appe");
                WriteLiteral(@"nd(boton);
                    $('#modal-alerta').modal('show');
                } 
            });
        }
            ...
            $.ajax({
                ...
                success: function (respuesta)
                {
                    if (respuesta == true)
                    {
                        ...
                        $('#title-alerta-informacion').text(""Declaración de gastos finalizada"");
...
");
                WriteLiteral(@"
                    ...
                    else
                    {
                        ...
                        var boton = '<button type=""button"" data-dismiss=""modal"" class=""btn btn-danger tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium mg-b-2");
                WriteLiteral(@"0"">Aceptar</button>';
                        $('#actions-alerta').empty().append(boton);
                        $('#modal-alerta').modal('show');
                    }
                },
       ...
       ");
                ...
                error: function (XMLHttpRequest, textStatus, errorThrown)
                {
                    $('#title-alerta').text(textStatus);
                    $('#body-alerta').text(errorThrown);
                    var boton = '<button type=""but");
                WriteLiteral(@"ton"" data-dismiss=""modal"" class=""btn btn-danger tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium mg-b-20"">Aceptar</button>';
                    $('#actions-alerta').empty().append(boton);
                    $('#modal-alerta').modal('show');
                } 
            });
            ...
            $.ajax({
                ...
                success: function (respuesta)
                {
                    if (respuesta == true)
                    {
                        $('#icono-alerta-informacion').empty().append('<i class=""icon icon ion-ios-checkmark-outline tx-100 tx-success lh-1 mg-t-20 d-inline-block""></i>');
                        $('#title-alert");
                WriteLiteral(@"a-informacion').text(""Declaración de gastos aceptada"");
                    ...
                    else
                    {
                        $('#icono-alerta').empty().append('<i class=""icon icon ion-ios-close-outline tx-100 tx-danger lh-1 mg-t-20 d-inline-block""></i>');
                        $('#title-alerta').text(""Alerta"");
                        $('#body-alerta').text(""No se ha aceptado la declaración de gastos. Favor de volver a intentarlo y si el pro");
                WriteLiteral(@"blema persiste, contactese con soporte."");
                        var boton = '<button type=""button"" data-dismiss=""modal"" class=""btn btn-danger tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium mg-b-20"">Aceptar</button>';
                        $('#actions-alerta').empty().append(boton);
                        $('#modal-alerta').modal('show');
                    }
            ...
            switch (tipoEvento)
            {
                ...
                default:
                    $.ajax({
                        ...
                        success: function (respuesta)
                        {
                            window.location.href = '/DeclaracionGastos/");
        ...
        function eliminarDocumentosDG()
        {
            ...
            var botonCancelar = '");
                WriteLiteral(@"<button type=""button"" data-dismiss=""modal"" class=""btn btn-secondary tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium mg-b-20 mg-r-5"">Cancelar</button >';
    ...
    ");
                WriteLiteral(@"                {
                    ...
                    else if (respuesta == ""0"")
                    {
                        ...
                        var boton = '<button type=""button"" data-dismiss=""modal"" class=""btn btn-danger tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium mg-b-20"">Aceptar</button>';
                        $('#actions-alerta').empty().append(bo");
                WriteLiteral(@"ton);
                        $('#modal-alerta').modal('show');
                    }
                    else
