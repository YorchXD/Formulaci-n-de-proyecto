#pragma checksum "D:\Repositorios\Formulación de proyecto\Aplicacion web\SimRend\SimRend\Views\DeclaracionGastos\VerDeclaracionGastos.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5b114c498587947e7bf699cfe1f6c4ed8db0e803"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5b114c498587947e7bf699cfe1f6c4ed8db0e803", @"/Views/DeclaracionGastos/VerDeclaracionGastos.cshtml")]
                ...
                WriteLiteral(@"
        {
            $.ajax({
                ...
                success: function (respuesta)
                {
                    ...
                    $('#totalRendido').val(fo");
                WriteLiteral(@"rmatoNumero(respuesta.proceso.declaracionGastos.totalRendido));
                ...
                switch (estado)
                {
                    case 3:
                        acciones = '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volverProceso"" style=""width:100%""><i class=""fas fa-sitemap""></i> Volver a proceso</button> </div>' +
                            ...
                            '<div class=""form-group  col-lg-12 col-md-12 col-sm-12""><button class=""modal-effect btn btn-info"" data-effect=""effect-just-me"" style=""width:100%"" onclick=""documentacion()""><i class=""fas");
                WriteLiteral(@" fa-plus""></i> Agregar Documentación</button> </div>';
                    ...
                    case 4:
                        acciones = '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volverProceso"" style=""width:100%""><i class=""fas fa-sitemap""></i> Volver a proceso</button> </div>' +
                            ...
                            '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-danger"" style=""width:100%"" onclick=""eliminarDocumentosDG()""><i class=""fas fa-tras");
                WriteLiteral(@"h""></i> Eliminar</button> </div>' +
                    ...
                    default:
                        acciones = '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volverProceso"" style=""width:100%""><i class=""fas fa-sitemap""></i> Volver a proceso</button> </div>' +
                            '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volverProcesos"" style=""width:100%""><i class=""fas fa-clipboard-list""></i> Volver a procesos</button> </div>' +
          ");
                WriteLiteral(@"                  '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""modal-effect btn btn-secondary"" data-effect=""effect-just-me"" style=""width:100%"" onclick=""documentacion()""><i class=""fas fa-eye""></i> Documentación</button> </div>' +
       ...
       ");
                WriteLiteral(@"     else
            {
                switch (estado)
                {
                    ...
                    case 4:
                        acciones = '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volverProceso"" style=""width:100%""><i class=""fas fa-sitemap""></i> Volver a proceso</button> </div>' +
                            '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volverProcesos"" style=""width:100%""><i class=""f");
                WriteLiteral(@"as fa-clipboard-list""></i> Volver a procesos</button> </div>' +
                    ...
                    default:
                        acciones = '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volverProceso"" style=""width:100%""><i class=""fas fa-sitemap""></i> Volver a proceso</button> </div>' +
                            '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volverProcesos"" style=""width:100%""><i class=""fas fa-clipboard-list""></i> Volver a procesos</button> </div>' +
                            '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""modal-effect btn btn-info"" data-effect=""effect-just-me"" id = ""documentacion"" s");
                WriteLiteral(@"tyle=""width:100%""><i class=""fas fa-eye""></i> Documentación</button> </div>' +
            ...
            {
                e.preventDefault();
                $('#icono-alerta-informacion').empty().append('<i class=""icon icon ion-ios-help-outline tx-100 tx-success lh-1 mg-t-20 d-inline-");
                WriteLiteral(@"block""></i>');
            ...
            $('#finalizar').click(function (e)
            {
                e.preventDefault();
                $");
                WriteLiteral(@"('#icono-alerta-informacion').empty().append('<i class=""icon icon ion-ios-help-outline tx-100 tx-success lh-1 mg-t-20 d-inline-block""></i>');
...
");
            ...
            $('#aceptar').click(function (e)
            {
                ...
                $('#actions-ale");
                WriteLiteral(@"rta-informacion').empty().append(botonCancelar);
                $('#actions-alerta-informacion').append(botonAceptar);
                $('#modal-alerta-informacion').modal('show');
            });
            ...
            $.ajax({
                ...
                success: function (respuesta)
                {
                    if (respuesta == true)
                    {
                        ...
                        $('#body-alerta-informacion').text(""La selección de documentación automatica para la dec");
                WriteLiteral(@"laración de gastos se ha realizado exitosamente."");
                    ...
                    else
                    {
                        ...
                        var boton = '<button type=""button"" data-d");
                WriteLiteral(@"ismiss=""modal"" class=""btn btn-danger tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium mg-b-20"">Aceptar</button>';
                        $('#actions-alerta').empty().append(boton);
                        $('#modal-alerta').modal('show');
                    }
                },
            ...
            $.ajax({
                ...
                success: function (respuesta)
                {
                    if (respuesta == true)
                    {
                        ...
                        var botonAceptar = '<button ");
                WriteLiteral(@"type=""button"" data-dismiss=""modal"" class=""btn btn-success tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium mg-b-20 mg-r-5"" onclick=""CerrarModalAlertaInfo()"">Aceptar</button >';
                    ...
                    else
                    {
                        ...
                        var boton = '<button type=""button"" data-dismiss=""modal"" class=""btn btn-danger tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium mg-b-20"">Aceptar</button>';
                        $('#actio");
                WriteLiteral(@"ns-alerta').empty().append(boton);
                        $('#modal-alerta').modal('show');
                    }
                },
                error: function (XMLHttpRequest, textStatus, errorThrown)
        ...
        function documentacion()
        {
            ...
            {
                case 'Grupal':
                    window.location.href = '/DeclaracionGastos/Documentacio");
                WriteLiteral(@"nPersonas';
                    break;
                default:
                    $.ajax({
                        async: false,
            ...
            ");
                ...
                success: function (respuesta)
                {
                    ...
                    else if (respuesta == ""0"")
                    {
                        $('#icono-alerta').empty().append('<i class=""icon icon ion-ios-close-outline tx-100 tx-danger lh-1 mg-t-20 d-inline-block""></i>');
                        $('#title-alerta').text(""Alerta"");
                        $('#body-alerta').text(""No se eliminaron los documentos de la declaración de gastos debido a que no ex");
                WriteLiteral(@"isten."");
                        var boton = '<button type=""button"" data-dismiss=""modal"" class=""btn btn-danger tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium mg-b-20"">Aceptar</button>';
                        $('#actions-alerta').empty().append(boton);
                        $('#modal-alerta').modal('show');
