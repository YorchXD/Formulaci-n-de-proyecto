#pragma checksum "D:\Repositorios\Formulación de proyecto\Aplicacion web\SimRend\SimRend\Views\DeclaracionGastos\VerDeclaracionGastos.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "f84befeb07f2bcffea54332052ad34faf9b4d8a9"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"f84befeb07f2bcffea54332052ad34faf9b4d8a9", @"/Views/DeclaracionGastos/VerDeclaracionGastos.cshtml")]
...
<div class=""br-pagebody"">
        ...
        <div class=""modal-dialog modal-dialog-centered"" role=""document"">
            <div class=""modal-content tx-size-sm"">
                <div class=""modal-body tx-center pd-y-20 pd-x-20"">
                    <i class=""icon ion-ios-checkmark-outline tx-100 tx-suc");
            WriteLiteral(@"cess lh-1 mg-t-20 d-inline-block""></i>
    ...
    <div id=""modal-alerta"" class=""modal fade"" data-backdrop=""static"" data-keyboard=""false"">
        <div class=""modal-dialog modal-dialog-centered"" role=""document"">
            <div class=""modal-content tx-size-sm"">
                <div class=""modal-body tx-center pd-y-20 pd-x-20"">
                    <i class=""icon icon ion-ios-close-outline tx-10");
...
");
        ...
        function verOpciones(estado, estadoFinal)
        {
                ...
                WriteLiteral(@"        break;
                    default:
                        acciones = '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volverProceso"" style=""width:100%""><i class=""fas fa-sitemap""></i> Volver a proceso</button> </div>' +
                            ...
                            '<div class=""fo");
                WriteLiteral(@"rm-group  col-lg-6 col-md-6 col-sm-12""><button class=""modal-effect btn btn-danger"" data-effect=""effect-just-me"" id = ""rechazar"" style=""width:100%""><i class=""fas fa-window-close""></i> Declaración rechazada</button> </div>' +
                            '<div class=""form-group col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-info"" id=""aceptar"" style=""width:100%""><i class=""fas fa-check-square""></i> Declaración aceptda</button> </div>';
                        break;
                }
            }
            else
            {
                switch (estado)
                {
                    case 3:
                        acciones = '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volverProceso"" style=""width:100%""><i class=""fas fa-sitemap""></i> Volver a proceso</button> </div>' +
                            '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volverProcesos"" style=""width:100%""><i class=""fas fa-c");
                WriteLiteral(@"lipboard-list""></i> Volver a procesos</button> </div>';
                    ...
                    case 4:
                        ...
                        break;
                    default:
                        acciones = '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondar");
                WriteLiteral(@"y"" id=""volverProceso"" style=""width:100%""><i class=""fas fa-sitemap""></i> Volver a proceso</button> </div>' +
                            '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volverProcesos"" style=""width:100%""><i class=""fas fa-clipboard-list""></i> Volver a procesos</button> </div>' +
            ...
            {
                e.preventDefault();
                alert('Declaración de gastos aceptada.');
            });
 ...
 ");
        ...
        {
            $('#title-alerta-eliminar-documento'");
                WriteLiteral(@").text(""Eliminar documentos"");
        ...
        function confirmarEliminarDocumentosDG()
        {
            ...
            $.ajax({
                async: false,
                url: ""/Declaraci");
                WriteLiteral(@"onGastos/EliminarDocumentosDG"",
                method: ""POST"",
                data: """",
                success: function (respuesta)
                {
        ...
        $('#btn-DocumentosEliminados').click(function (e)
        {
            ...
            wind");
                WriteLiteral("ow.location.href = \'/DeclaracionGastos/VerDeclaracionGastos\';\r\n        });\r\n    </script>\r\n");
            }
            );
        }
