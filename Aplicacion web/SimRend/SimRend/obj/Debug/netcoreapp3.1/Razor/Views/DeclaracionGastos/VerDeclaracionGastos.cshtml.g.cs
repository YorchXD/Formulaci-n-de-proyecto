#pragma checksum "D:\Repositorios\Formulación de proyecto\Aplicacion web\SimRend\SimRend\Views\DeclaracionGastos\VerDeclaracionGastos.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "70a5b2e681313402f2e33a46c8da5e2ca2f6ad7d"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"70a5b2e681313402f2e33a46c8da5e2ca2f6ad7d", @"/Views/DeclaracionGastos/VerDeclaracionGastos.cshtml")]
...
<div class=""br-pagebody"">
            ...
            if (estadoFinal == ""Abierto"")
            {
                ...
                WriteLiteral(@"switch (estado)
                {
                    case 3:
                        ...
                        break;
                    case 4:
                        acciones = '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volverProceso"" style=""width:100%""><i cla");
                WriteLiteral(@"ss=""fas fa-sitemap""></i> Volver a proceso</button> </div>' +
                            '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volverProcesos"" style=""width:100%""><i class=""fas fa-clipboard-list""></i> Volver a procesos</button> </div>' +
                ...
                WriteLiteral(@"         '<div class=""form-group col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-info"" id=""finalizar"" style=""width:100%""><i class=""fas fa-file-signature""></i> Finalizar declaración</button> </div>';
                    ...
                    default:
                        acciones = '<div class=""form-group  col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""volverProceso"" style=""width:100%""><i class=""fas fa-sitemap""></i> Volver a proceso</button> </div>' +
                            ...
                            '<di");
                WriteLiteral(@"v class=""form-group col-lg-6 col-md-6 col-sm-12""><button class=""btn btn-secondary"" id=""descargar"" style=""width:100%""><i class=""fas fa-download""></i> Descargar</button> </div>' +
  ...
  ");
            ...
            $('#generar').click(function (e)
            {
                ...
                var botonCancelar = '<button ty");
                WriteLiteral(@"pe=""button"" data-dismiss=""modal"" class=""btn btn-secondary tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium mg-b-20 mg-r-5"">Cancelar</button >';
            ...
            $('#finalizar').click(function (e)
            {
                ...
                $('#body-alerta-informacion').text(""¿E");
                WriteLiteral(@"stá seguro que desea finalizar la delcaración de gastos?"");
            ...
            $('#rechazar').click(function (e)
            {
                e.preventDefault();
                $('#icono-alerta').em");
                WriteLiteral(@"pty().append('<i class=""icon icon ion-ios-help-outline tx-100 tx-danger lh-1 mg-t-20 d-inline-block""></i>');
            ...
            {
                e.preventDefault();
                $('#icono-alerta-informacion')");
                WriteLiteral(@".empty().append('<i class=""icon icon ion-ios-help-outline tx-100 tx-success lh-1 mg-t-20 d-inline-block""></i>');
            ...
            $.ajax({
                ...
                success: function (respuesta)
                {
                    if (respuesta == true)
                    {
                        ...
                        var botonAceptar = '<button type=""button"" data-dismiss=""modal"" class=""btn btn-success tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium mg-b-20");
                WriteLiteral(@" mg-r-5"" onclick=""CerrarModalAlertaInfo()"">Aceptar</button >';
            ...
            $.ajax({
                ...
                success: function (respuesta)
                {
                    if (respuesta == true)
                    {
                        ...
                        var botonAceptar = '<button type=""button"" data-dismiss=""modal"" class=""btn btn-danger tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium mg-b-20 mg-r-5"" onclick=""");
                WriteLiteral(@"CerrarModalAlerta()"">Aceptar</button >';
            ...
            $.ajax({
                ...
                success: function (respuesta)
                {
                    if (respuesta == true)
                    {
                        ...
                        var botonAceptar = '<button type=""button"" data-dismiss=""modal"" class=""btn btn-success tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium mg-b-20 m");
                WriteLiteral(@"g-r-5"" onclick=""CerrarModalAlertaInfo()"">Aceptar</button >';
  ...
  ");
        ...
        function eliminarDocumentosDG()
        {
            ...
            $('#actions-alerta-");
                WriteLiteral(@"eliminar-documento').append(botonAceptar);
        ...
        function confirmarEliminarDocumentosDG()
        {
            ...
            $.ajax({
                ...
                WriteLiteral(@"'<i class=""icon icon ion-ios-close-outline tx-100 tx-danger lh-1 mg-t-20 d-inline-block""></i>');
                        $('#title-alerta').text(""Alerta"");
                    ...
                    else
                    {
                        $('#icono-alerta').empty().append('<i class=""icon icon ion-ios-close-outline tx-100 tx-danger lh-1 mg-t-20 d-inline-block""></i>');
                        $('#title-alerta').text(""Alerta"");
                        $('#body-alerta').text(""No se eliminaron los documentos debido a que ha ocurrido un problema de conexión.");
                WriteLiteral(@" Favor de volver a intentarlo y si el problema persiste contactar a soporte"");
                        var boton = '<button type=""button"" data-dismiss=""modal"" class=""btn btn-danger tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium mg-b-20"">Aceptar</button>';
                        $('#actions-alerta').empty().append(boton);
                        $('#modal-alerta').modal('show');
                    }
